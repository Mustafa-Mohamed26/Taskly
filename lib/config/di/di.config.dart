...
import '../../presentation/main_layout/focus/cubit/focus_cubit.dart' as _i499;
import '../../presentation/main_layout/tasks/cubit/sync_cubit.dart' as _i522;
import '../../presentation/main_layout/tasks/cubit/task_cubit.dart' as _i409;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i499.FocusCubit>(() => _i499.FocusCubit());
    gh.factory<_i409.TaskCubit>(() => _i409.TaskCubit());
    ...
    gh.factory<_i250.TaskRepository>(() => _i538.TaskRepositoryImpl(
          gh<_i807.TaskRemoteDataSource>(),
          gh<_i272.TaskLocalDataSource>(),
        ));
    gh.factory<_i522.SyncCubit>(() => _i522.SyncCubit(
