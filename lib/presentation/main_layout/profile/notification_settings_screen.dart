    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: AppStyles.titleLarge(Theme.of(context).colorScheme.onSurface),
        ),
        centerTitle: true,
      ),
      body: ListView(
        ...
        children: [
          _buildSectionHeader(context, 'APP NOTIFICATIONS'),
          ...
          _buildSectionHeader(context, 'ACCOUNT UPDATES'),
          SizedBox(height: 16.h),
          _buildNotificationItem(
            context: context,
  ...
  Widget _buildInfoCard(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.info_outline, color: Theme.of(context).colorScheme.primary, size: 20.sp),
          SizedBox(width: 12.w),
          Expanded(
            child: Text(
              'You can manage more granular settings for specific teams or projects in the individual project settings menu.',
              style: AppStyles.bodySmall(Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.8)).copyWith(height: 1.5),
            ),
          ),
        ],
      ),
